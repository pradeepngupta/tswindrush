...
export default function AboutPage() {
	return (
		<Layout>
			...
			<p className="lead">
				TSWinDRush is a modern web development stack that combines TypeScript,
				Tailwind CSS, and Next.js to provide a robust foundation for building
			...
			<ul>
				...
				<li>Powered by Next.js 13+ with App Router for optimal performance</li>
			...
			<h2>Our Mission</h2>
			<p>
				We aim to provide developers with a modern, type-safe, and performant
				development stack that enables them to build production-ready
				applications quickly and efficiently.
			</p>

			<h2>Getting Started</h2>
			<p>
				To start using TSWinDRush, you can create a new project using our CLI:
			</p>
			<pre>
			...
			<h2>License</h2>
			<p>TSWinDRush is open-source software licensed under the MIT license.</p>
		</Layout>
	)
}
